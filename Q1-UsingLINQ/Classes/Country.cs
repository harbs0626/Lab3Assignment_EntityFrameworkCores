        ...
        public static List<Country> GetCountries()
        {
            return new List<Country>()
            {
                ...
                new Country( "Bolivia", 1083301, 15280,
                            ...
                            new List<string>{ "tin", "natural gas", "petroleum", "zinc", "tungsten", "antimony", "silver", "iron", "lead", "gold", "timber", "hydropower" }, 
                            11138234,
                ...
                new Country( "Chile", 743812, 12290,
                            ...
                            new List<string>{ "copper", "timber", "iron ore", "nitrates", "precious metals", "molybdenum", "hydropower" }, 
                            1778267,
                ...
                new Country( "Argentina", 2736690, 43710,
                            ...
                            new List<string>{ "fertile plains of the pampas", "lead", "zinc", "tin", "copper", "iron ore", "manganese", "petroleum", "uranium", "arable land" }, 
                            44293293,
                ...
                new Country( "Guyana", 196849, 18120,
                            ...
                            new List<string>{ "bauxite", "gold", "diamonds", "hardwood", "timber", "shrimp", "fish" }, 
                            737718,
                ...
                new Country( "French Guiana", 89150, 1850,
                            ...
                            new List<string>{ "shrimp", "timber", "gold", "rum" }, 
                            191309,
                ...
                new Country( "Suriname", 156000, 7820,
                            ...
                            new List<string>{ "timber", "hydropower", "fish", "kaolin", "shrimp", "bauxite", "gold", "nickel", "copper", "platinum", "iron ore" }, 
                            591919,
                ...
                new Country( "Brazil", 8358140, 157630,
                            ...
                            new List<string>{ "bauxite", "gold", "iron ore", "manganese", "nickel", "phosphate", "platinum", "tin", "rare earth elements", "uranium", "petroleum", "hydropower", "timber" }, 
                            207353391,
                ...
                new Country( "Ecuador", 276841, 6720,
                            ...
                            new List<string>{ "petroleum", "fish", "timber", "hydropower" }, 
                            16290913,
                ...
                new Country( "Uruguay", 175015, 1200,
                            ...
                            new List<string>{ "arable land", "hydropower", "minor minerals", "fish" }, 
                            3360148,
